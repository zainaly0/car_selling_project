...
<section class="hero-slider">
    ...
    <div class="hero-slides">
        ...
        <button type="button" class="hero-slide-prev">
            <svg style="width: 18px" aria-hidden="true" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 6 10">
        ...
        <div class="container">
            ...
            <div class="car-items-listing">
                <div class="car-item card">
                    <a href="/view.html">
                        <img src="{{asset('img/cars/Lexus-RX200t-2016/1.jpeg')}}" alt="" class="car-item-img rounded-t" />
                    </a>
                    <div class="p-medium">
